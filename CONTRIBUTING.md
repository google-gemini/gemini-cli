...
```bash
git clone https://github.com/Icarus603/gemini-code.git # Or your fork's URL
cd gemini-cli
```
...
- Consult [GEMINI.md](https://github.com/Icarus603/gemini-code/blob/main/GEMINI.md) (typically found in the project root) for specific instructions related to AI-assisted development, including conventions for React, comments, and Git usage.
