...
*Last Synchronized: 2026-04-09 21:31 (UTC)*

**Total 'Help Wanted' Issues tracked: 177**

## 🆕 Awaiting Reviewer Pickup (36)
**Action: Pick up one of these new PRs.** No human reviewers assigned yet.

| Issue | Linked PR | Last Update |
| :--- | :--- | :--- |
| [#19711 Fix unsafe type assertions in Core Tool Execution (Phase 2.1)](https://github.com/google-gemini/gemini-cli/issues/19711) | [#24126](https://github.com/google-gemini/gemini-cli/pull/24126) | `2026-03-30` |
...
| [#22035 Allow wrapping tool descriptions to prevent truncation in the UI](https://github.com/google-gemini/gemini-cli/issues/22035) | [#21964](https://github.com/google-gemini/gemini-cli/pull/21964) | `2026-04-08` |
...
| [#18487 A2A Server should support multiple workspace directories](https://github.com/google-gemini/gemini-cli/issues/18487) | [#23872](https://github.com/google-gemini/gemini-cli/pull/23872) | `2026-03-28` |
...
| [#19583 feat(policy): support granular skill activation permissions](https://github.com/google-gemini/gemini-cli/issues/19583) | [#21837](https://github.com/google-gemini/gemini-cli/pull/21837) | `2026-03-23` |
...
| [#18593 Valid chat JSON missing from `/resume` list; forcing resume with `--resume` loads incorrect Session ID](https://github.com/google-gemini/gemini-cli/issues/18593) | [#19633](https://github.com/google-gemini/gemini-cli/pull/19633) | `2026-03-12` |
| [#20661 [Bug] run_shell_command returns garbled Chinese text for the Agent, while referenced files   (@filename) work correctly](https://github.com/google-gemini/gemini-cli/issues/20661) | [#20684](https://github.com/google-gemini/gemini-cli/pull/20684) | `2026-03-11` |
| [#21142 feat(cli): add /stats perf subcommand for memory and startup timing display](https://github.com/google-gemini/gemini-cli/issues/21142) | [#22727](https://github.com/google-gemini/gemini-cli/pull/22727) | `2026-03-16` |
| [#21230 feat: visualize tool and /visualize command](https://github.com/google-gemini/gemini-cli/issues/21230) | [#24192](https://github.com/google-gemini/gemini-cli/pull/24192) | `2026-03-30` |
| [#21340 feat: Add configurable shell executable for run_shell_command on Windows](https://github.com/google-gemini/gemini-cli/issues/21340) | [#22018](https://github.com/google-gemini/gemini-cli/pull/22018) | `2026-03-11` |
| [#19919 "Failed to persist policy" error despite correct permissions](https://github.com/google-gemini/gemini-cli/issues/19919) | [#21541](https://github.com/google-gemini/gemini-cli/pull/21541) | `2026-04-09` |

## ⌛ Awaiting Reviewer Follow-up (11)
**Action: Reviewers, please follow up.** Author has responded to feedback.

| Issue | Linked PR | Reviewers | Status |
| :--- | :--- | :--- | :--- |
| [#18067 Feature Proposal: Unified Native Voice Input Architecture (Local-First)](https://github.com/google-gemini/gemini-cli/issues/18067) | [#18499](https://github.com/google-gemini/gemini-cli/pull/18499) | @jacob314, @mrpmohiburrahman, @scidomino | Author Updated |
| [#19387 should trust a folder if the rule matches the realpath flakes on windows](https://github.com/google-gemini/gemini-cli/issues/19387) | [#19901](https://github.com/google-gemini/gemini-cli/pull/19901) | @jacob314 | Author Updated |
...
| [#20838 CTRL-z removes unfinished open questions in AskUser tool](https://github.com/google-gemini/gemini-cli/issues/20838) | [#20873](https://github.com/google-gemini/gemini-cli/pull/20873) | @jackwotherspoon, @mrpmohiburrahman | Author Updated |
| [#20968 Windows PowerShell Output Encoding Bug](https://github.com/google-gemini/gemini-cli/issues/20968) | [#21179](https://github.com/google-gemini/gemini-cli/pull/21179) | @mrpmohiburrahman | Author Updated |
...
| [#20730 gemini is not able to view files that exist, and I am not able to tag them (despite not being gitignored/geminiignored)](https://github.com/google-gemini/gemini-cli/issues/20730) | [#20738](https://github.com/google-gemini/gemini-cli/pull/20738) | @jacob314 | Review Requested |

## ✍️ Awaiting Author Action (38)
**Status: Waiting for contributor to address review comments.**

| Issue | Linked PR | Reviewers | Last Feedback |
| :--- | :--- | :--- | :--- |
| [#19985 CLI hangs/freezes when using `@filename:line` or `@filename:range` syntax](https://github.com/google-gemini/gemini-cli/issues/19985) | [#20175](https://github.com/google-gemini/gemini-cli/pull/20175) |  | `2026-04-09` |
...
| [#19649 extend /copy to capture output also from slash commands](https://github.com/google-gemini/gemini-cli/issues/19649) | [#19825](https://github.com/google-gemini/gemini-cli/pull/19825) | @lesteral, @mrpmohiburrahman | `2026-04-04` |
...
| [#15503 feat: github colorblind themes](https://github.com/google-gemini/gemini-cli/issues/15503) | [#15504](https://github.com/google-gemini/gemini-cli/pull/15504) | @cocosheng-g | `2026-03-15` |
...
| [#21221 Proposal: Interruptible responses for experimental voice mode](https://github.com/google-gemini/gemini-cli/issues/21221) | [#21226](https://github.com/google-gemini/gemini-cli/pull/21226) |  | `2026-04-08` |
...
| [#22001 Terminal Instance Resource Retention in ShellExecutionService](https://github.com/google-gemini/gemini-cli/issues/22001) | [#22055](https://github.com/google-gemini/gemini-cli/pull/22055) |  | `2026-04-08` |
...
| [#22351 Improve diagnostics and error handling for malformed streaming responses](https://github.com/google-gemini/gemini-cli/issues/22351) | [#22352](https://github.com/google-gemini/gemini-cli/pull/22352) |  | `2026-04-09` |
| [#21505 docs(sdk): add JSDoc to exported interfaces in packages/sdk/src/types.ts](https://github.com/google-gemini/gemini-cli/issues/21505) | [#21584](https://github.com/google-gemini/gemini-cli/pull/21584) |  | `2026-04-08` |
...
| [#22611 bug: Stale 'Thinking...' state persists after response completion](https://github.com/google-gemini/gemini-cli/issues/22611) | [#22619](https://github.com/google-gemini/gemini-cli/pull/22619) | @cocosheng-g | `2026-04-09` |
...
| [#20675 [Bug]: Interactive shell does not show properly on Windows 10 when using arrow keys in external subshell prompts (v0.31.0)](https://github.com/google-gemini/gemini-cli/issues/20675) | [#23505](https://github.com/google-gemini/gemini-cli/pull/23505) |  | `2026-04-09` |
...
| [#22691 Ability to specify the exact workspace directory without walking up file tree](https://github.com/google-gemini/gemini-cli/issues/22691) | [#22861](https://github.com/google-gemini/gemini-cli/pull/22861) |  | `2026-04-08` |
| [#12083 Container name collisions due to sequential numbering in container name generation](https://github.com/google-gemini/gemini-cli/issues/12083) | [#19534](https://github.com/google-gemini/gemini-cli/pull/19534) | @mrpmohiburrahman | `2026-04-04` |
| [#18751 feat(ui): support custom preferred themes for automatic light/dark switching](https://github.com/google-gemini/gemini-cli/issues/18751) | [#18753](https://github.com/google-gemini/gemini-cli/pull/18753) |  | `2026-04-09` |
| [#18914 [Android/Termux] Fix duplicate UI and repeated auth prompts caused by relauncher loop and resize remounting](https://github.com/google-gemini/gemini-cli/issues/18914) | [#18969](https://github.com/google-gemini/gemini-cli/pull/18969) |  | `2026-04-09` |
...
| [#21400 Add an update command](https://github.com/google-gemini/gemini-cli/issues/21400) | [#21426](https://github.com/google-gemini/gemini-cli/pull/21426) |  | `2026-04-09` |
...
| [#22934 test(acp): add missing coverage for extensions command error paths](https://github.com/google-gemini/gemini-cli/issues/22934) | [#23060](https://github.com/google-gemini/gemini-cli/pull/23060) |  | `2026-04-09` |
| [#22920 AgentLoopContext is incompatible with Config type](https://github.com/google-gemini/gemini-cli/issues/22920) | [#22981](https://github.com/google-gemini/gemini-cli/pull/22981) |  | `2026-04-09` |
...
| [#23018 ACP: Execute tool call title field contains conversational text.](https://github.com/google-gemini/gemini-cli/issues/23018) | [#23092](https://github.com/google-gemini/gemini-cli/pull/23092) |  | `2026-04-09` |
...
| [#21084 External editor support: unclear error messages, missing editors, incomplete documentation](https://github.com/google-gemini/gemini-cli/issues/21084) | [#21377](https://github.com/google-gemini/gemini-cli/pull/21377) |  | `2026-03-11` |

## 🌱 Available for Pickup (52)
**Action: Open for new contributors.** Unassigned with no open PR.
...
| [#22079 extensions install fails to find gemini-extension.json from GitHub URL](https://github.com/google-gemini/gemini-cli/issues/22079) | 0 |
| [#22452 BUG: CI_* env var scrub not applied in dev mode (`npm run start`) — interactive mode hangs](https://github.com/google-gemini/gemini-cli/issues/22452) | 0 |
| [#22738 [Windows/WezTerm] Shift+Tab and fallback F10 fail to cycle approval mode (Keystroke logs included)](https://github.com/google-gemini/gemini-cli/issues/22738) | 0 |
...
| [#17834 Website landing and extensions page flash when theme is set to light](https://github.com/google-gemini/gemini-cli/issues/17834) | 0 |
...
## 🛠️ Active Development (40)
**Status: Contributor is currently working on this (Assigned < 14 days ago).**
