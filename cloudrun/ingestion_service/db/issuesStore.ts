import { Firestore, FieldValue, DocumentReference, Transaction } from '@google-cloud/firestore';
...
export class IssuesStore {
  ...
  getIssueRef(owner: string, repo: string, issueNumber: number): DocumentReference {
  ...
  async createIssue(owner: string, repo: string, issueNumber: number, title: string): Promise<boolean> {
