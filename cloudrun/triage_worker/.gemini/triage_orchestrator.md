...
2. If the quality is **"OK"**:
   ...
   - **Invoke the `spec` skill** to create the technical implementation plan.
...
```json
{
  "triage_metadata": {
    ...
    "effort_reasoning": "Reasoning from effort-estimator skill" (if quality is OK, otherwise empty string)
  },
  "workable_spec": {
