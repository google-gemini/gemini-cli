...
describe('extractGoalOptions', () => {
  it('should extract 3-4 goals from conversation history', async () => {
    const history = [
      { role: 'user', parts: [{ text: 'Help me implement user authentication' }] },
      { role: 'model', parts: [{ text: 'I can help with that. Let me create...' }] },
...
it('should timeout goal extraction after 5 seconds', async () => {
  ...
  expect(result.success).toBe(false)
  expect(result.goals).toEqual(expect.arrayContaining(['Continue current task']))
})
```
...
describe('Config accessors', () => {
  it('should provide getter for each compression setting', () => {
    ...
    expect(config.getCompressionTriggerUtilization()).toBe(0.50)
...
**Test File:** `packages/cli/src/ui/components/messages/CompressionPrompt.test.tsx`
...
**Test File:** `packages/cli/src/ui/components/messages/CompressionMessage.test.tsx`
...
it('should force compression at 50% utilization', async () => {
  ...
  const compressionEvent = telemetry.find(e => e.event === 'chat_compression')
...
it('should handle rapid concurrent compression attempts', async () => {
  ...
  const compressed = results.filter(r => r.status === CompressionStatus.COMPRESSED)
...
When your conversation reaches 40k tokens, Gemini will check in to learn what you're working on:
...
- [x] Enhanced compression prompt (3 tests)
- [x] Compression service integration (3 tests)

### Phase 2: Triggers & Guards ✅
- [x] Hybrid trigger system (5 tests)
- [x] Concurrency guards (5 tests)

### Phase 3: Goal Extraction ✅
- [x] Extract goals from history (5 tests)

### Phase 4: User Prompt ✅
- [x] Prompt user for goal (4 tests)
- [x] Opt-out handling (5 tests)

### Phase 5: Integration ✅
- [x] Complete tryCompressChat flow (4 tests)
- [x] State management (3 tests)

### Phase 6: Configuration ✅
- [x] Settings schema (2 tests)
- [x] Config accessors (2 tests)

### Phase 7: UI ✅
- [x] Compression prompt component (6 tests)
- [x] Compression message component (4 tests)

### Phase 8: Telemetry ✅
- [x] Enhanced logging (3 tests)

### Phase 9: Integration Tests ✅
- [x] E2E scenarios (5 tests)
...
**Commits: ~70 incremental commits**
...
### Day 1: Core Logic
- Morning: Module 1.1 (split strategy)
- Afternoon: Module 1.2 (prompt enhancement)
- Evening: Module 1.3 (service integration)

### Day 2-3: Triggers & Guards
- Day 2 AM: Module 2.1 (trigger logic)
- Day 2 PM: Module 2.2 (concurrency)
- Day 3: Continue guards, testing

### Day 4: Goal Extraction
- Full day: Module 3.1 (extraction, truncation, validation)

### Day 5-6: User Interaction
- Day 5: Module 4.1 (prompting)
- Day 6: Module 4.2 (opt-outs)

### Day 7-8: Main Integration
- Day 7: Module 5.1 (complete flow)
- Day 8: Module 5.2 (state management) + Module 6 (config)

### Day 9-10: UI & Telemetry
- Day 9: Module 7 (UI components)
- Day 10: Module 8 (telemetry) + Module 9 (integration tests)

### Day 11: Polish & Performance
- Module 10 (docs) + Module 11 (performance)

---

*TDD Work Plan v1.0 - Comprehensive test-driven implementation strategy*
