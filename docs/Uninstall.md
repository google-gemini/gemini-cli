...
If you installed the CLI globally (e.g., `npm install -g @icarus603/gemini-code`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @icarus603/gemini-code
```
