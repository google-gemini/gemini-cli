...
- 🎉**Gemini CLI Extensions:** _ **Conductor:** Planning++, Gemini works with
  you to build out a detailed plan, pull in extra details as needed, ultimately
  to give the LLM guardrails with artifacts. Measure twice, implement once! \
  `gemini extensions install https://github.​com/gemini-cli-extensions/conductor` _
  Blog:
  ...
  **Endor Labs: **Perform code analysis, vulnerability scanning, and dependency
  checks using natural language. \
