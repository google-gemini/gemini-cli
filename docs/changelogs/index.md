...
- **Data Commons Gemini CLI Extension** - A new Data Commons Gemini CLI
  ...
  [datacommons.org](https://datacommons.org). **To get started, you'll need a
  Data Commons API key and uv installed**. These and other details to get you
  started with the extension can be found at
