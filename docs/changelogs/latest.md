...
- fix(patch): cherry-pick bd53951 to release/v0.44.0-pr-27496 [CONFLICTS] by
  @gemini-cli-robot in
  [#27534](https://github.com/google-gemini/gemini-cli/pull/27534)
...
**Full Changelog**:
https://github.com/google-gemini/gemini-cli/compare/v0.44.0...v0.44.1
