# Preview release: Release v0.30.0-preview.3
...
- update isActiveModel to return false for unknown models by sehoon38
- only use customtoolmodel for api key users by sehoon38 in
  [#132](https://github.com/google-gemini/gemini-cli/pull/132)
- feat(models): support Gemini 3.1 custom tool model by sehoon38 in
  [#131](https://github.com/google-gemini/gemini-cli/pull/131)
- feat(core,ui): support Gemini 3.1 Pro Preview and active model filtering by
  sehoon38 in [#125](https://github.com/google-gemini/gemini-cli/pull/125)
...
**Full changelog**:
https://github.com/google-gemini/gemini-cli/compare/v0.28.0-preview.0...v0.30.0-preview.3
