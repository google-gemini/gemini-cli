...
| `--acp`                          | -     | boolean | -         | Start in ACP (Agent Client Protocol) mode. See [ACP mode](./acp-mode.md).                                                                                              |
| `--experimental-acp`             | -     | boolean | -         | **Deprecated.** Use `--acp` instead. Start in ACP (Agent Client Protocol) mode.                                                                                        |
