...
| `--resume`                       | `-r`  | string  | -         | Resume a previous session. Use `"latest"` for most recent, or a session index, ID, or alias (e.g. `--resume 5`, `--resume my-fix`)                                     |
| `--list-sessions`                | -     | boolean | -         | List available sessions for the current project and exit                                                                                                               |
| `--delete-session`               | -     | string  | -         | Delete a session by index, ID, or alias (use `--list-sessions` to see available sessions)                                                                              |
