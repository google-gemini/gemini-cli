...
| `--approval-mode`                | -     | string  | `default` | Approval mode for tool execution. Choices: `default`, `auto_edit`, `full_access`, `full-access`, `yolo`, `plan`                                                        |
| `--full-access`                  | -     | boolean | `false`   | Auto-approve all tool calls in a trusted workspace.                                                                                                                    |
| `--yolo`                         | `-y`  | boolean | `false`   | **Deprecated.** Alias for `--full-access`.                                                                                                                             |
