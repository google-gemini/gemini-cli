...
- **`/privacy`**
  - **Description:** Displays the Privacy Policy that applies to your usage of the Gemini CLI. If your license allows data collection, you will be given the option to select **Yes** to enable data collection or **No** to disable data collection. Data collection is further described in the Gemini CLI [Terms of Service and Privacy Notice](../tos-privacy.md).
  - **Usage:** `/privacy`
  - **Note:** Some methods of authenticating to the Gemini CLI will disallow data collection by default. Refer to the Gemini CLI [Terms of Service and Privacy Notice](../tos-privacy.md) for more information.
