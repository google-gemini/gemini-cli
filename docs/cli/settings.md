...
| Enable Linting          | `general.lsp.lintEnabled`          | Enable automatic linting after file edits.                                                                                                                                                                                                                    | `true`                          |
| Lint Command            | `general.lsp.lintCommand`          | Command to run for linting (e.g., "npx eslint"). The file path will be automatically appended to the command.                                                                                                                                                 | `"npx eslint"`                  |
| Enable Type Checking    | `general.lsp.typeCheckEnabled`     | Enable automatic type checking after file edits.                                                                                                                                                                                                              | `true`                          |
| Type Check Command      | `general.lsp.typeCheckCommand`     | Command to run for type checking (e.g., "tsc --noEmit --skipLibCheck"). The file path will be automatically appended to the command.                                                                                                                          | `"tsc --noEmit --skipLibCheck"` |
