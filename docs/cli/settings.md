...
| Preferred Light Theme                | `ui.preferredLightTheme`                | The theme to use when the terminal background is light (auto-switching must be enabled).                                                                          | `undefined` |
| Preferred Dark Theme                 | `ui.preferredDarkTheme`                 | The theme to use when the terminal background is dark (auto-switching must be enabled).                                                                           | `undefined` |
