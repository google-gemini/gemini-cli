...
| UI Label                       | Setting                           | Description                                                                                                                                                       | Default |
| ------------------------------ | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Hide Window Title              | `ui.windowTitle`                  | Hide the window title bar.                                                                                                                                        | `false` |
| Show Status in Title           | `ui.windowTitleStatus`            | Show Gemini CLI status and thoughts in the terminal window title.                                                                                                 | `false` |
| Show Home Directory Warning    | `ui.homeDirectoryWarning`         | Show a warning when running Gemini CLI in the home directory.                                                                                                     | `true`  |
| Hide Tips                      | `ui.usageTips`                    | Hide helpful usage tips in the UI.                                                                                                                                | `false` |
| Hide Banner                    | `ui.applicationBanner`            | Hide the application startup banner.                                                                                                                              | `false` |
| Hide Context Summary           | `ui.contextSummary`               | Hide the context summary (GEMINI.md, MCP servers) above the input.                                                                                                | `false` |
| Hide CWD                       | `ui.footer.workingDirectory`      | Hide the current working directory path in the footer.                                                                                                            | `false` |
| Hide Sandbox Status            | `ui.footer.sandboxStatus`         | Hide the sandbox status indicator in the footer.                                                                                                                  | `false` |
| Hide Model Info                | `ui.footer.modelInfo`             | Hide the model name and context usage in the footer.                                                                                                              | `false` |
| Hide Context Window Percentage | `ui.footer.contextPercentage`     | Hides the context window remaining percentage.                                                                                                                    | `true`  |
| Hide Footer                    | `ui.footerEnabled`                | Hide the footer from the UI.                                                                                                                                      | `false` |
...
| Load Memory From Include Directories | `context.includeDirectoryMemory`            | Controls how /memory refresh loads GEMINI.md files. When true, include directories are scanned; when false, only the current directory is used. | `false` |
...
| UI Label                       | Setting                                         | Description                                                            | Default |
| ------------------------------ | ----------------------------------------------- | ---------------------------------------------------------------------- | ------- |
| Disable YOLO Mode              | `security.yoloMode`                             | Disable YOLO mode, even if enabled by a flag.                          | `false` |
