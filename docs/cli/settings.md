...
| Enable Linting          | `general.lsp.lintEnabled`          | Enable automatic linting after file edits.                                                                                                                                                                                                                    | `false`                                                 |
| Lint Command            | `general.lsp.lintCommand`          | Command to run for linting (e.g., "eslint"). The file path will be automatically appended to the command.                                                                                                                                                     | `"eslint"`                                              |
| Enable Type Checking    | `general.lsp.typeCheckEnabled`     | Enable automatic type checking after file edits.                                                                                                                                                                                                              | `false`                                                 |
| Type Check Command      | `general.lsp.typeCheckCommand`     | Command to run for type checking (e.g., "tsc --project tsconfig.json --noEmit --skipLibCheck"). The file path will be automatically appended to the command.                                                                                                  | `"tsc --project tsconfig.json --noEmit --skipLibCheck"` |
| Max Diagnostics         | `general.lsp.maxDiagnostics`       | Maximum number of diagnostics to report per file.                                                                                                                                                                                                             | `10`                                                    |
| Run on Edit             | `general.lsp.runOnEdit`            | Run diagnostics automatically after file edits.                                                                                                                                                                                                               | `true`                                                  |
| Run on Demand           | `general.lsp.runOnDemand`          | Allow running diagnostics on demand via commands.                                                                                                                                                                                                             | `true`                                                  |
