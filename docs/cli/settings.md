...
| Approval Mode                    | `tools.approvalMode`                 | The default approval mode for tool execution. 'default' prompts for approval, 'auto_edit' auto-approves edit tools, 'yolo' auto-approves all tools, and 'plan' is read-only mode. | `"default"` |
