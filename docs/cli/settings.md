...
| Terminal Title Max Length            | `ui.terminalTitleMaxLen`               | Maximum length of the terminal window title.                                                                                                                      | `80`     |
| Pad Window Title                     | `ui.padWindowTitle`                    | Pad the terminal window title with spaces to a fixed length to prevent taskbar jitter.                                                                            | `true`   |
