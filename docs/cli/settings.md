...
| Path Hint Truncation Threshold   | `tools.truncatePathHintThreshold`    | Truncate the file path shown when the agent is using a tool. This helps you identify the target file while keeping the display concise. Set to -1 to disable.                  | `35`        |
