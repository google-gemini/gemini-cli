...
| Hyperlinks                                           | `experimental.hyperlinks`           | Render file paths and URLs in responses as clickable hyperlinks (OSC 8) in supported terminals (VS Code, iTerm2, Ghostty, WezTerm, Windows Terminal, etc.). Unsupported terminals display plain text unchanged. | `false` |
