...
| Idle Shutdown (minutes) | `general.idleShutdownMinutes`      | Automatically close the CLI after this many minutes of inactivity (waiting for user input). Leave unset or set to 0 to disable.                                                                                                                               | `undefined` |
