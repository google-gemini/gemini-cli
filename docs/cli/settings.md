...
| Hide Context Window Percentage | `ui.footer.hideContextPercentage`        | Hides the remaining context window percentage. Requires `ui.footer.hideModelInfo` and `ui.hideFooter` to be `false`.                                               |
