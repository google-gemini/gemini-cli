...
| Smart Policy Scoping                  | `security.enableSmartPolicyScoping`             | To suggest better-scoped policy rules, allow Gemini to analyze tool approvals. Displays a suggested scope description on approval options.                                                                                           | `false` |
