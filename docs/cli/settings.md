...
| Dynamic Model Configuration | `experimental.dynamicModelConfiguration` | Enable dynamic model configuration (definitions, resolutions, and chains) via settings.                                                                   | `false` |
