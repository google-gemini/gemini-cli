...
| **User** ([user config directory](../reference/configuration.md#configuration-directory), for example `~/.config/gemini-cli/...`) | Configured by you. You are responsible for ensuring they are safe.                                                         |
