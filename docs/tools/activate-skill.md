...
The `activate_skill` tool allows the Gemini agent to load specialized procedural
...
tasks, such as reviewing code or creating pull requests. The agent uses this
