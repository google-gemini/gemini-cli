...
def main():
    ...
    for issue in issues:
        ...
        for event in timeline_nodes:
            ...
            # 6. PR status check must NOT be FAILURE or ERROR (Allow SUCCESS, PENDING, or NONE)
    ...
    # Remove previously mentioned issues
    mentioned = [22929, 22920, 17235, 18727, 18751, 20675, 22591, 22616, 22351, 21635, 21370, 21036, 22321, 22611]
    filtered_new = [i for i in valid_issues if i['number'] not in mentioned]
    
    print(f"Found {len(filtered_new)} new valid issues matching the criteria.\\n")
