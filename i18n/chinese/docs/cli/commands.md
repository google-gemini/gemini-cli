[查看英文版](https://github.com/google-gemini/gemini-cli/blob/main/docs/cli/commands.md)
...
- **`/memory`**
  ...
  - **子命令：**
    ...
    - **注意：** 有关 `GEMINI.md` 文件如何为分层内存做出贡献的更多详细信息，请参阅 [CLI 配置文档](./configuration.md#4-geminimd-files-hierarchical-instructional-context)。
