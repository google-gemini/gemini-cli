...
` : `[${source[i]}\r
  ...
  var BrowserContextManager = class {
    context;
    listeners = [];
    MAX_TABS = 10;
    ...
    async initializeCurrentTabs() {
      try {
        ...
        const activeTabs = tabs.filter((tab) => tab.id !== void 0 && tab.url && !tab.url.startsWith("chrome://")).slice(0, this.MAX_TABS).map((tab) => this.tabToBrowserTab(tab));
    ...
    removeTab(tabId) {
      ...
      if (this.context.currentPage) {
        ...
        if (!currentTab) {
          this.context.currentPage = void 0;
        }
      }
    }
    async updateCurrentPageContext(tabId) {
      try {
    ...
    extractPageContext() {
      ...
      const selectedText = (selection == null ? void 0 : selection.toString().trim()) || void 0;
      const body = document.body;
      const visibleText = ((_a = body == null ? void 0 : body.innerText) == null ? void 0 : _a.substring(0, 4096)) || void 0;
      const getElementInfo = (element, maxDepth = 3) => {
        var _a2;
      ...
      return {
        selectedText: selectedText && selectedText.length <= 16384 ? selectedText : selectedText == null ? void 0 : selectedText.substring(0, 16384),
        visibleText,
        pageStructure: pageStructure.slice(0, 20)
  ...
  // src/background.ts
  var GEMINI_CLI_PORT = "gemini-cli-port";
  var MCP_SERVER_PORT = "mcp-server-port";
  var BrowserMcpServer = class {
    mcpServer;
    contextManager;
    ...
    handleMcpMessage(sessionId, message) {
      console.log(`Received MCP message from ${sessionId}:`, message);
    }
    sendInitialContext(sessionId) {
  ...
  var browserMcpServer = new BrowserMcpServer();
