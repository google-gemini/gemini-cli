...
export async function loadCliConfig(
  ...
  return new Config({
    ...
    agents: settings.experimental?.agents,
    ...
    toolOutputTruncation: settings.tools?.toolOutputTruncation,
    ...
    hooksEnabled: getEnableHooks(settings),
    hooksUI: getEnableHooksUI(settings),
