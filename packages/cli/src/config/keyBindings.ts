...
export enum Command {
  ...
  TOGGLE_SESSIONS_VIEW = 'toggleSessionsView',
...
export const defaultKeyBindings: KeyBindingConfig = {
  ...
  [Command.TOGGLE_SESSIONS_VIEW]: [{ key: 'o', ctrl: true }],
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.TOGGLE_SESSIONS_VIEW]: 'Toggle the sessions dashboard.',
