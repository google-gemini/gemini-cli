...
export const SETTINGS_SCHEMA = {
  ...
  model: {
    ...
    properties: {
      ...
      quotaEstimation: {
        type: 'object',
        label: 'Quota Estimation',
        category: 'Model',
        requiresRestart: false,
        default: {},
        description: 'Settings for estimating quota usage before executing queries.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable Quota Estimation',
            category: 'Model',
            requiresRestart: false,
            default: false,
            description: 'Show an estimate of quota usage before executing queries.',
            showInDialog: true,
          },
          showDetailedBreakdown: {
            ...
            requiresRestart: false,
            default: false,
            description: 'Show detailed token breakdown including input, output, and total estimates.',
            showInDialog: true,
          },
        },
      },
