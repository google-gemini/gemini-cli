      ...
      auth: {
        ...
        properties: {
          ...
          autoFallback: {
            ...
            category: 'Security',
            requiresRestart: false,
            default: { enabled: false, type: 'gemini-api-key' },
            description:
              'Automatically switch authentication when hitting quota limits',
            showInDialog: false,
            properties: {
              enabled: {
                type: 'boolean',
                ...
                requiresRestart: false,
                default: false,
                description: 'Enable automatic fallback when quota is exceeded',
                showInDialog: true,
              },
              type: {
                type: 'enum',
                ...
                description: 'Which authentication method to fallback to',
                showInDialog: true,
                options: [
