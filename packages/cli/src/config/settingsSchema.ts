...
export const SETTINGS_SCHEMA = {
  ...
  codebaseIndexing: {
    ...
    requiresRestart: false,
    default: {},
    description: 'Settings for codebase indexing and semantic search.',
    showInDialog: false,
    properties: {
      embedEndpoint: {
        type: 'string',
      ...
      batchSize: {
        ...
        requiresRestart: false,
        default: 32,
        description: 'Number of text units to process in a single batch',
        showInDialog: true,
      },
      maxTextChars: {
        type: 'number',
        ...
        requiresRestart: false,
        default: 8192,
        description: 'Maximum number of characters per text unit',
        showInDialog: true,
      },
      mergeThreshold: {
        type: 'number',
        ...
        requiresRestart: false,
        default: 40,
        description: 'Minimum characters for merging short lines',
        showInDialog: true,
      },
      skipIfLargerThan: {
        type: 'number',
      ...
      autoIndexingInterval: {
        type: 'number',
        label: 'Auto-Indexing Interval',
        category: 'Codebase Indexing',
        requiresRestart: false,
        default: 5000,
        description: 'Interval for auto-indexing checks (in milliseconds)',
        showInDialog: true,
      },
    },
  },
