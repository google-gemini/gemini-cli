  ...
  tools: {
    ...
    properties: {
      ...
      enableToolOutputTruncation: {
        ...
        requiresRestart: true,
        default: false,
        description: 'Enable truncation of large tool outputs. When disabled, long outputs will be displayed in full with scrolling support.',
        showInDialog: true,
      },
      ...
      showFullLongResponses: {
        type: 'boolean',
        label: 'Show Full Long Responses',
        category: 'General',
        requiresRestart: false,
        default: true,
        description: 'When enabled, long model responses will be displayed in full without truncation. Use scrolling to navigate through long responses.',
        showInDialog: true,
      },
    },
  },
