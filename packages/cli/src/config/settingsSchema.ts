  ...
  general: {
    ...
    properties: {
      ...
      lsp: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Language Server Protocol (LSP) diagnostics settings.',
        showInDialog: false,
        properties: {
          lintEnabled: {
            type: 'boolean',
          ...
          lintCommand: {
            ...
            default: 'npx eslint',
            description:
              'Command to run for linting (e.g., "npx eslint"). The file path will be automatically appended to the command.',
            showInDialog: true,
          },
          typeCheckEnabled: {
            type: 'boolean',
          ...
          typeCheckCommand: {
            ...
            description:
              'Command to run for type checking (e.g., "tsc --noEmit --skipLibCheck"). The file path will be automatically appended to the command.',
            showInDialog: true,
          },
        },
      },
