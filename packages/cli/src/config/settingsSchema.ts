...
const SETTINGS_SCHEMA = {
  ...
  routing: {
    ...
    properties: {
      numericalRules: {
        type: 'array',
        label: 'Numerical Routing Rules',
        category: 'Advanced',
        requiresRestart: true,
        default: [] as { maxScore: number; model: string }[],
        description: 'Rules for numeric routing based on complexity.',
        showInDialog: false,
        items: {
          type: 'object',
          properties: {
            maxScore: {
              ...
              requiresRestart: false,
              default: 0,
              description: 'Maximum score for this routing rule.',
              showInDialog: false,
            },
            model: {
              type: 'string',
              ...
              requiresRestart: false,
              default: '',
              description: 'Model alias or ID to route to.',
              showInDialog: false,
            },
          },
        },
