  ...
  experimental: {
    ...
    properties: {
      ...
      useModelRouter: {
        ...
        default: {},
        description:
          'Use the model router to select the best model for the job.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            ...
            requiresRestart: true,
            default: false,
            description: 'Enable the model router.',
            showInDialog: true,
          },
          useGemmaRouting: {
            type: 'object',
            ...
            requiresRestart: true,
            default: {},
            description: 'Use Gemma routing for model selection.',
            showInDialog: false,
            properties: {
              enabled: {
                type: 'boolean',
                label: 'Enable Gemma Routing',
                category: 'Experimental',
                requiresRestart: true,
                default: false,
              ...
              model: {
                ...
                requiresRestart: true,
                default: 'gemma:2b',
                description: 'The Gemma model to use.',
                showInDialog: false,
              },
              host: {
                type: 'string',
                ...
                description: 'The host for the Gemma model.',
                showInDialog: false,
              },
              provider: {
                type: 'enum',
                label: 'Gemma Provider',
                category: 'Experimental',
                requiresRestart: true,
                default: 'ollama',
