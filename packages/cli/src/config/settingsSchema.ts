  ...
  general: {
    ...
    properties: {
      ...
      notifications: {
        ...
        requiresRestart: false,
        default: undefined,
        description: 'Audio notification settings for user alerts.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            ...
            default: false,
            description:
              'Enable audio notifications for user input and task completion.',
            showInDialog: false,
          },
          events: {
            type: 'object',
            ...
            requiresRestart: false,
            default: undefined,
            description: 'Configuration for specific notification events.',
            showInDialog: false,
            properties: {
              inputRequired: {
                type: 'object',
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Notification when user input is required.',
                showInDialog: false,
                properties: {
                  enabled: {
                    type: 'boolean',
                    label: 'Enable Input Required Notification',
                    category: 'General',
                    requiresRestart: false,
                    default: true,
                    description: 'Play sound when user input is required.',
                    showInDialog: false,
                  },
                  sound: {
                    type: 'enum',
                    ...
                    requiresRestart: false,
                    default: 'system',
                    description: 'Type of sound to play (system or custom).',
                    showInDialog: false,
                    options: [
                  ...
                  customPath: {
                    ...
                    default: undefined as string | undefined,
                    description:
                      'Path to custom sound file (used when sound type is custom).',
                    showInDialog: false,
                  },
                },
              },
              taskComplete: {
                ...
                properties: {
                  enabled: {
                    type: 'boolean',
                    label: 'Enable Task Complete Notification',
                    category: 'General',
                    requiresRestart: false,
                    default: true,
                    description: 'Play sound when a task is completed.',
                    showInDialog: false,
                  },
                  sound: {
                    type: 'enum',
              ...
              idleAlert: {
                ...
                default: undefined,
                description:
                  'Notification when the system has been idle for a period.',
                showInDialog: false,
                properties: {
                  enabled: {
                    type: 'boolean',
                    ...
                    default: true,
                    description:
                      'Play sound when system has been idle for the timeout period.',
                    showInDialog: false,
                  },
                  timeout: {
                    type: 'number',
                    ...
                    category: 'General',
                    requiresRestart: false,
                    default: 60 as number | undefined,
                    description:
                      'Number of seconds to wait before triggering idle alert.',
                    showInDialog: false,
                  },
                  sound: {
                    type: 'enum',
