...
const SETTINGS_SCHEMA = {
  ...
  experimental: {
    ...
    properties: {
      ...
      generalSubagentSettings: {
        type: 'object',
        label: 'General Subagent Settings',
        category: 'Experimental',
        requiresRestart: true,
        default: {},
        description:
          'Configuration for General Subagent (a general-purpose subagent that is an exact copy of the main Gemini CLI agent).',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable General Subagent',
            category: 'Experimental',
            requiresRestart: true,
            default: false,
            description: 'Enable the General Subagent.',
            showInDialog: true,
          },
          maxNumTurns: {
            type: 'number',
            label: 'General Subagent Max Num Turns',
            category: 'Experimental',
            requiresRestart: true,
            default: 100,
            description: 'Maximum number of turns for the General Subagent.',
            showInDialog: false,
          },
          maxTimeMinutes: {
            type: 'number',
            ...
            requiresRestart: true,
            default: 30,
            description: 'Maximum time for the General Subagent (in minutes).',
            showInDialog: false,
          },
          thinkingBudget: {
            type: 'number',
            ...
            default: -1,
            description:
              'The thinking budget for the General Subagent (-1 for default).',
            showInDialog: false,
          },
          model: {
            type: 'string',
            ...
            default: 'auto',
            description:
              'The model to use for the General Subagent (auto to inherit from main agent).',
            showInDialog: false,
          },
          temp: {
            type: 'number',
            ...
            requiresRestart: true,
            default: 0.7,
            description: 'The temperature for the General Subagent.',
            showInDialog: false,
          },
        },
      },
