...
describe('agentsCommand', () => {
  ...
  it('should show an error if config is not available for enable', async () => {
    ...
    const result = await enableCommand!.action!(contextWithoutConfig);
    expect(result).toEqual({
      type: 'message',
      messageType: 'error',
      content: 'Config not loaded.',
  ...
  it('should show an error if config is not available for disable', async () => {
    ...
    const result = await disableCommand!.action!(contextWithoutConfig);
    expect(result).toEqual({
      type: 'message',
      messageType: 'error',
      content: 'Config not loaded.',
  ...
  describe('config sub-command', () => {
    ...
    it('should show an error if config is not available', async () => {
      ...
      const result = await configCommand!.action!(contextWithoutConfig);
      expect(result).toEqual({
        type: 'message',
        messageType: 'error',
        content: 'Config not loaded.',
