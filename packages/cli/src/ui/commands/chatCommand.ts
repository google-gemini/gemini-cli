  ...
  action: async (context, args): Promise<SlashCommandActionReturn | void> => {
    ...
    if (!tag) {
      return {
        type: 'message',
        messageType: 'error',
        content: `Missing tag. Usage: /${context.invocation?.name || 'resume'} save <tag>`,
      };
    }
  ...
  action: async (context, args) => {
    ...
    if (!tag) {
      return {
        type: 'message',
        messageType: 'error',
        content: `Missing tag. Usage: /${context.invocation?.name || 'resume'} resume <tag>`,
      };
    }
  ...
  action: async (context, args): Promise<MessageActionReturn> => {
    ...
    if (!tag) {
      return {
        type: 'message',
        messageType: 'error',
        content: `Missing tag. Usage: /${context.invocation?.name || 'resume'} delete <tag>`,
      };
    }
