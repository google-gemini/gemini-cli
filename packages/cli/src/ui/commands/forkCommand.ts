...
const saveCommand: SlashCommand = {
  name: 'save',
  description:
    'Save the current conversation as a checkpoint. Usage: /fork save <tag>',
...
const resumeCommand: SlashCommand = {
  ...
  altName: 'load',
  description:
    'Resume a conversation from a checkpoint. Usage: /fork resume <tag>',
...
export const forkCommand: SlashCommand = {
  name: 'fork',
  description: 'Fork and manage conversation checkpoints.',
