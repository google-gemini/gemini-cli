  ...
  return (
    ...
    >
      {!uiState.embeddedShellFocused && (
        <LoadingIndicator
          thought={
            ...
            config.getAccessibility()?.loadingPhrases === false
              ? undefined
              : uiState.thought
          }
      ...
      <Box
        marginTop={1}
        justifyContent={
          !settings.merged.ui?.contextSummary ? 'flex-start' : 'space-between'
        }
        width="100%"
      ...
      {settings.merged.ui?.footerEnabled && !isScreenReaderEnabled && (
        <Footer />
      )}
    </Box>
  );
