...
export const HooksList: React.FC<HooksListProps> = ({ hooks }) => (
    <Box flexDirection="column" marginTop={1} marginBottom={1}>
      <Text>
        Hooks are scripts or programs that Gemini CLI executes at specific
        points in the agentic loop, allowing you to intercept and customize
        behavior.
      </Text>
      ...
      <Box marginTop={1} flexDirection="column">
        ...
        <Text color={theme.status.warning}>
          ...
          from sources you trust. Review hook scripts before enabling them.
        </Text>
      </Box>
