...
import type { JsonMcpPrompt, JsonMcpTool } from '../../types.js';
...
interface McpStatusProps {
  ...
  serverAuthStatus: (serverName: string) => React.ReactNode;
                    ...
                    <Box key={tool.name} flexDirection="column">
                      ...
                      {schemaContent && (
                        <Box flexDirection="column" marginLeft={4}>
                          <Text color={theme.text.primary}>Parameters:</Text>
                          <Text color={theme.text.primary}>
                            {schemaContent}
                          </Text>
                        </Box>
