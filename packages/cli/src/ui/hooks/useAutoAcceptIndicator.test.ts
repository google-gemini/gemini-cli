...
import { Config, ApprovalMode } from '@llmcli/core';
import type { Config as ActualConfigType } from '@llmcli/core';
...
vi.mock('@llmcli/core', async () => {
  const actualServerModule = (await vi.importActual('@llmcli/core')) as Record<
    string,
    unknown
  >;
  return {
