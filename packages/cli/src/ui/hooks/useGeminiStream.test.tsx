...
vi.mock('./useStateAndRef.js', async () => {
  ...
  return {
    useStateAndRef: vi.fn((initial) => {
      ...
      if (initial === false || initial === StreamingState.Idle) {
...
describe('useGeminiStream', () => {
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const testConfig = Object.assign(Object.create(mockConfig), {
        getContentGenerator: vi.fn(),
        getContentGeneratorConfig: vi.fn(() => ({
  ...
  describe('Thought Reset', () => {
    ...
    it('should update lastOutputTime on Gemini thought and content events', async () => {
      ...
      expect(result.current.lastOutputTime).toBe(startTime + 1050);
