...
export const INFORMATIVE_TIPS = [
  ...
  'Keep an eye on performance by showing memory usage (/settings)...',
  'Show line numbers in the chat for better context (/settings)...',
  'See where the model gets its information by showing citations (/settings)...',
  'Disable loading phrases for a quieter experience (/settings)...',
  'Add your own custom witty phrases to the loading screen (settings.json)...',
  'Enable IDE integration mode for a seamless workflow (settings.json)...',
  'Help improve Gemini by enabling usage statistics (/settings)...',
  'Choose a specific Gemini model for your conversations (/settings)...',
  ...
  'Set the maximum number of directories to scan for context files (settings.json)...',
  'Expand your workspace with additional directories (settings.json)...',
  'Control how the /memory refresh command loads context files (settings.json)...',
  'Toggle whether to respect .gitignore files for context (/settings)...',
  'Toggle whether to respect .geminiignore files for context (/settings)...',
  ...
  'Restrict the set of available built-in tools (settings.json)...',
  'Exclude specific tools from being used (settings.json)...',
  'Bypass confirmation for trusted tools you use frequently (settings.json)...',
  ...
  'Enforce a specific authentication type for enterprise use (settings.json)...',
  'Let Node.js auto-configure memory for you (settings.json)...',
  'Customize the DNS resolution order (settings.json)...',
  'Exclude certain environment variables from the context (settings.json)...',
  ...
  'Choose whether to log the content of your prompts (settings.json)...',
