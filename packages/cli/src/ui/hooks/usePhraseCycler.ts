...
export const WITTY_LOADING_PHRASES = [
  ...
  'Training the neural network on dad jokes...',
  'Checking if P = NP...',
  'Waiting for the promise to resolve...',
  'Interpreting the tea leaves...',
  'Running npm install on the universe...',
  'Convincing the AI it is not a toaster...',
  'Searching for the any key...',
  'Refactoring the spacetime continuum...',
  'Asking Stack Overflow...',
  'Trying to find the end of the infinite loop...',
  'Locating the missing closing brace...',
  'Running on caffeine and hope...',
  'Generating hallucinations... wait, no, facts...',
  'Expanding the context window...',
  'Thinking inside the box... no, outside...',
  'Talking to the ghost in the machine...',
  'Simulating consciousness...',
  'Calculating the meaning of life (it is 42)...',
  'Checking the logs... so many logs...',
  'Performing a séance for dead code...',
  'Updating the spinny thing...',
  'Thinking thoughts...',
  'Doing the math...',
  ...
  'Generating a response faster than a speeding bullet...',
