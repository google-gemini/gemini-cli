...
describe('useSlashCompletion', () => {
  ...
  describe('Command Source Information', () => {
    it('should include source for file commands in suggestions', async () => {
      const slashCommands = [
        {
          name: 'user-cmd',
    ...
    it('should include source when filtering commands by prefix', async () => {
      const slashCommands = [
        {
          name: 'deploy',
    ...
    it('should include source for sub-commands', async () => {
      const slashCommands = [
        {
          name: 'ext',
