...
import { debugLogger, isGitRepository } from '@llmcli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @llmcli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @llmcli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @llmcli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @llmcli@latest';
    return {
