...
describe('hasGemini35FlashGAAccess model setting', () => {
  ...
  it('should set DEFAULT_GEMINI_FLASH_MODEL to gemini-3.6-flash and PREVIEW_GEMINI_FLASH_MODEL to gemini-3-flash-preview if hasGemini35FlashGAAccess returns true and authType is USE_GEMINI', () => {
    const config = new Config(baseParams);
    ...
    expect(DEFAULT_GEMINI_FLASH_MODEL).toBe('gemini-3.6-flash');
    expect(PREVIEW_GEMINI_FLASH_MODEL).toBe('gemini-3-flash-preview');
  });

  it('should set DEFAULT_GEMINI_FLASH_MODEL and PREVIEW_GEMINI_FLASH_MODEL to gemini-3.6-flash if hasGemini35FlashGAAccess returns true and authType is not USE_GEMINI', () => {
    const config = new Config(baseParams);
    ...
    expect(DEFAULT_GEMINI_FLASH_MODEL).toBe('gemini-3.6-flash');
    expect(PREVIEW_GEMINI_FLASH_MODEL).toBe('gemini-3.6-flash');
  });
});
