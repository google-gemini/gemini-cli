...
export class Config implements McpContext, AgentLoopContext {
  ...
  private classifyWritePath(
    ...
    // workspace or project-temp allowlists below. When the call carries the
    // scoped extraction context, narrow exceptions for the canonical
    // `{private,global}/extraction.patch` paths are honored as projectTemp
    // (so secure permissions still apply).
