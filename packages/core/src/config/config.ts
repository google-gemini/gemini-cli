...
import { AdbTool } from '../tools/adb.js';
...
export class Config {
  ...
  private readonly adbSudoMode: boolean = false;
  ...
  constructor(params: ConfigParameters) {
    ...
    this.adbSudoMode = params.adbSudoMode ?? false;
  ...
  getAdbSudoMode(): boolean {
    return this.adbSudoMode;
  }
