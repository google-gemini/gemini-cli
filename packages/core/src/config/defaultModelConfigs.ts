...
export const DEFAULT_MODEL_CONFIGS: ModelConfigServiceConfig = {
  ...
  modelDefinitions: {
    ...
    'gemini-3.1-pro-preview': {
      ...
      features: { thinking: true, multimodalToolUse: true, modern: true },
    },
    ...
    'gemini-3-flash-preview': {
      ...
      isPreview: true,
      dialogLocation: 'manual',
      features: { thinking: false, multimodalToolUse: true, modern: true },
    },
    'gemini-2.5-pro': {
      tier: 'pro',
      family: 'gemini-2.5',
      isPreview: false,
      dialogLocation: 'manual',
      features: { thinking: false, multimodalToolUse: false, modern: false },
    },
    'gemini-2.5-flash': {
      tier: 'flash',
      family: 'gemini-2.5',
    ...
    flash: {
      tier: 'flash',
      isPreview: false,
      features: { thinking: false, multimodalToolUse: false, modern: true },
    },
    'flash-lite': {
      tier: 'flash-lite',
      isPreview: false,
