...
export const DEFAULT_BEDROCK_SMALL_FAST_MODEL =
  'us.anthropic.claude-3-5-haiku-20241022-v1:0';
export const DEFAULT_BEDROCK_OPUS_MODEL =
  'us.anthropic.claude-opus-4-20250514-v1:0';

// Additional Claude models available on Bedrock
export const DEFAULT_BEDROCK_SONNET_4_MODEL =
  'us.anthropic.claude-sonnet-4-20250514-v1:0';
export const DEFAULT_BEDROCK_CLAUDE_35_SONNET_V2_MODEL =
