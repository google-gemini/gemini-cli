...
export class HeapAnalyzer {
    static parseSnapshot(filePath) {
        const content = fs.readFileSync(filePath, 'utf-8');
        return JSON.parse(content);
    }
    static getStats(snapshot) {
    ...
    static findLargeObjects(snapshot, limit = 10) {
    ...
    static exportToPerfetto(snapshot, outputPath) {
    ...
    static findPotentialLeaks(snapshots) {
