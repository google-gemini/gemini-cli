...
8.  **DETAILED TASKS**: Ensure that the tasks created have more detail in the title with an option for description as well. The description should contain more specific details and context than the title.`.trim();
}
