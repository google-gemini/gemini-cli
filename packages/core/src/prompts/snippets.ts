...
2. **Efficiency:** Autonomously combine discovery and drafting phases to minimize conversational turns. If the request is ambiguous, use ${formatToolName(
    ASK_USER_TOOL_NAME,
  )} to clarify. Otherwise, explore the codebase and write the draft in one fluid motion.
