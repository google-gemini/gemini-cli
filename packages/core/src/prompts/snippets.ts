...
- **Watchman Feedback:** Periodically, a specialized **Watchman** subagent will review your progress and provide feedback (marked as "System: Feedback from Watchman"). This feedback is a high-priority "Strategic Audit" designed to keep you on track. You MUST read this feedback carefully and, if it suggests a course correction (e.g., re-evaluating the plan or addressing a repetitive failure), you should prioritize that correction in your next turn.
