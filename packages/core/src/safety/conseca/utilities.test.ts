...
describe('utilities', () => {
  ...
  it('getGeminiClient should initialize config and return client with default model', async () => {
    ...
    (Config as unknown as ReturnType<typeof vi.fn>).mockReturnValue(mockConfigInstance);
    ...
    expect(mockConfigInstance.refreshAuth).toHaveBeenCalledWith(AuthType.USE_GEMINI);
