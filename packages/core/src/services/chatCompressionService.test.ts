...
describe('modelStringToModelConfigAlias', () => {
  it('should throw an error for unexpected aliases', () => {
    expect(() => modelStringToModelConfigAlias('gemini-flash-flash')).toThrow(
      'Unexpected model string: gemini-flash-flash',
    );
  });
