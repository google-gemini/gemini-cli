...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe
      STRIPE_SK_LIVE: 'REDACTED_STRIPE_LIVE_SK',
      STRIPE_RK_LIVE: 'REDACTED_STRIPE_LIVE_RK',
      STRIPE_SK_TEST: 'REDACTED_STRIPE_TEST_SK',
      STRIPE_RK_TEST: 'REDACTED_STRIPE_TEST_RK',
      // Slack
