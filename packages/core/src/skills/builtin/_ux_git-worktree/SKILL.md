...
2.  **ALWAYS** use the automation script: `./packages/core/src/skills/builtin/git-worktree/scripts/worktree-manager.sh pr 123`.
3.  This script will automatically fetch the PR title and create a semantic directory name (e.g., `pr-123-fix-core-bug`).
