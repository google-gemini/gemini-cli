...
export enum EventMetadataKey {
  ...
  GEMINI_CLI_INVALID_CHUNK_ERROR_MESSAGE = 70,

  GEMINI_CLI_CONTENT_RETRY_ATTEMPT_NUMBER = 71,

  GEMINI_CLI_CONTENT_RETRY_ERROR_TYPE = 72,

  GEMINI_CLI_CONTENT_RETRY_DELAY_MS = 73,

  GEMINI_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS = 74,

  GEMINI_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE = 75,

  GEMINI_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS = 76,
}
