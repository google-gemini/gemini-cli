            ...
            items: {
              ...
              properties: {
                ...
                header: {
                  ...
                  maxLength: 16,
                  description:
                    'MUST be 16 characters or fewer. Very short label displayed as a chip/tag. Use abbreviations: "Auth" not "Authentication", "Config" not "Configuration". Examples: "Auth method", "Library", "Approach", "Database".',
                },
                type: {
                  type: 'string',
