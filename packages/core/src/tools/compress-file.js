...
async function compressFile() {
  ...
  readline.question(
    chalk.blue(
      'Enter source path to compress (e.g., /data/data/com.termux/files/home/file.txt): ',
    ),
    (srcPath) => {
      ...
      readline.question(
        chalk.blue(
          'Enter zip file path (e.g., /data/data/com.termux/files/home/archive.zip): ',
        ),
        (zipPath) => {
          try {
            console.log(
              chalk.cyan(`// Binding '${srcPath}' into '${zipPath}'...`),
            );
            ...
            console.log(
              chalk.green(`Success! '${srcPath}' bound into '${zipPath}'.`),
            );
            readline.close();
          } catch (error) {
