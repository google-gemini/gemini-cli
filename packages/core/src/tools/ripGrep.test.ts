...
describe('RipGrepTool', () => {
  ...
  describe('execute', () => {
    ...
    it('should throw an error if ripgrep is not available', async () => {
      ...
      expect(await invocation.execute({ signal: abortSignal })).toStrictEqual({
  ...
  describe('advanced search options', () => {
    it('should handle case_sensitive parameter', async () => {
      ...
      let result = await invocation.execute({ signal: abortSignal });
      ...
      result = await invocation.execute({ signal: abortSignal });
      expect(mockSpawn).toHaveBeenLastCalledWith(
        expect.anything(),
    ...
    it('should disable gitignore rules when respectGitIgnore is false', async () => {
      ...
      await invocation.execute({ signal: abortSignal });
