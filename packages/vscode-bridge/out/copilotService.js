...
class CopilotService {
    ...
    async initialize() {
        try {
            ...
            if (models.length === 0) {
                ...
                if (vscode.lm.registerChatModelProvider) {
                ...
                throw new Error('No language models available. This could be because:\n' +
    ...
    async healthCheck() {
        try {
            ...
            if (!vscode.lm && !vscode.languageModels) {
            ...
            else if (vscode.languageModels) {
                const lm = vscode.languageModels;
