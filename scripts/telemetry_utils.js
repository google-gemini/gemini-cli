...
const USER_LLM_DIR = path.join(os.homedir(), LLM_DIR);
// Project-level .gemini directory in the workspace
const WORKSPACE_LLM_DIR = path.join(projectRoot, LLM_DIR);

// Telemetry artifacts are stored in a hashed directory under the user's ~/.gemini/tmp
export const OTEL_DIR = path.join(USER_LLM_DIR, 'tmp', projectHash, 'otel');
