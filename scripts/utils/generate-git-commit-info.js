...
console.log('Wrote', gitCommitFileTs);

// Also write a .js version for direct JS imports
const jsFileContent = `// This file is auto-generated by the build script (scripts/build.js)\n// Do not edit this file manually.\nexports.GIT_COMMIT_INFO = '${gitCommitInfo}';\n`;
writeFileSync(gitCommitFileJs, jsFileContent);
console.log('Wrote', gitCommitFileJs);
