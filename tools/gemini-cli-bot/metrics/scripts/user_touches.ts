...
try {
  ...
  console.log(`user_touches_overall,${Math.round(overall * 100) / 100}`);
  console.log(`user_touches_maintainers,${Math.round(maintainers * 100) / 100}`);
  console.log(`user_touches_community,${Math.round(community * 100) / 100}`);
